        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {tools.map((tool) => (
            <motion.div 
              key={tool.id} 
              variants={itemVariants}
              className="glass-card p-6 flex flex-col items-center text-center border-white/5 hover:border-white/10 transition-all"
            >
              <div className={`w-10 h-10 rounded-lg ${tool.iconBg} flex items-center justify-center mb-3`}>
